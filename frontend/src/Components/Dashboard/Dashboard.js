  ...
  setActiveTabKeys(prevState => ({
    ...
    return (
        ...
        <Menu
            ...
            style={{ height: '100%',
                borderRight: 0,
                backgroundColor: '#553CDF', // Light background
        ...
        >    
            ...
            <div style={{ marginBottom: '30px' ,width :"250px" , marginLeft :"10px"}}>
          ...
          <div style={{ marginBottom: '40px' ,width :"100px" , marginLeft :"60px",  backgroundColor:"white",
            color: "black"}}>
          <Button 
            >Apply</Button>
          </div>
