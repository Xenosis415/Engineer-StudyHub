...

{
    ...
    tags: ['#OFFLINE', '#FREE', '#DATA STRUCTURE & ALGORITHM'],
  ...
  },
  {
      ...
      tags: ['#ONLINE', '#FREE', '#DATA STRUCTURE & ALGORITHM'],
      organizedBy: 'Shipra Gupta',
  ...
  },
  {
    ...
    const opportunity = TrendingOpportunitiesCards.find(opportunity => opportunity.id === parseInt(id));


    if (!opportunity) return <div>Job not found</div>;

    return (
      <div  style={{marginTop: "50px", overflow: 'hidden', padding: '20px'}}>
        
          <Row style={{margin: "0px;"}} gutter={16}>
    <Col span={8}>
      <img style={{width: "100%"}} alt="example" src={opportunity.logo}/>
    </Col>
    <Col span={16}>
